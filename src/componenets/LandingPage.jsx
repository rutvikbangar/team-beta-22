            ...
            <nav className="w-full fixed top-0 left-0 bg-transparent py-4 px-8 z-10">
                <div className="flex justify-between items-center">
                    ...
                    <div className="text-white text-2xl font-bold">
                        <span>MOODE-MATE</span>
                    </div>
                    
                    {/* Navigation Links */}
                    <div className="flex space-x-6">
                        <a href="#login" className="text-dark-blue hover:text-gray-400 text-lg">Login</a>
                        <a href="#signup" className="text-dark-blue hover:text-gray-400 text-lg">Sign Up</a>
                    </div>
                </div>
            </nav>
